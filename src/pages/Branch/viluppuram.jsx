...
// import SudhaAbout from "@/assets/branch/ Viluppuram/ Viluppuram_about.webp";
import { motion } from "framer-motion";
import Pradeepa from "@/assets/branch/ambatur/pradeepa.webp";
// import Hospital from "@/assets/branch/ Viluppuram/ Viluppuram.webp";
...
import { villupuramVideos } from "@/middleware/videosRoute";
...
function ViluppuramPage() {
  ...
  const ViluppuramReview = [
    ...
    {
      quote:
        `This is Muthu from Villupuram. I knew the Sudha hospital through my friend. My daughter got married at 2019. She don't have child. So we went to Sudha hospital  Viluppuram for my daughter's fertility treatment. Now she delivered a boy baby. I really happy with my boy. I want to thank for each and every staff in this hospital.
  Once again I thank the doctor mam she gave hope to my family and my daughter. Nowadays we're very happy with my grandson. I thanks the Sudha hospital management with gratefulness.`,
    ...
    {
      quote:
        "Sudha hospital    Viluppuram branch  last 5years no kids  iam  send it sudha hospital      Viluppuram.   treatment   started  my saide vry improve  iam vry confidant  in my self  vry good exlent service counselling   also clearly  staff vry caring thank god",
      name: "Bharatha Selvi",
      title: "Patient",
    },
    {
    ...
    {
      quote:
        `😍💘👨‍👩‍👧Best hospital in  Viluppuram for fertility treatment. The care is top notch and positive vibes are best. Multiple visit on other hospitals are didn't work for us but here got good news in 1st month treatment itself.
  Got my princess after 5 yers through IUI on 25th Mar'23. Thanks a lot to Nivashini Mam, Archana, Dhanalakshmi and Vanitha Mam🙏💘😍👨‍👩‍👧. Try visit once then you will feel good vibes. ⚡`,
    ...
    {
      quote:
        "Sudha hospital  Viluppuram dr  staff good service   my sister 15 years no chid    iam going on sudha hospital  Dr nivashni staff vry good caring  treatment vry satisfied thank you sudha hospital  Viluppuram branch",
      name: "ᴠꜱ ᴄʀᴇᴀᴛɪᴏɴ",
      title: "Patient",
    },
    {
    ...
    {
      quote:
        "After 20 years we got a girl baby and Then my wife and family got so happy and it' s given by Sudha Fertility  Viluppuram Gift Because Me and my wife got treatment above 10 different IVF hospital But waste of Time and Money only because all treatment goes to failure 😭😭😭 and never I can't forget a sudha Fertility Centre  Viluppuram with the help of Madurai Sudha Hospital Also , because all staff are treated like a Family and Their Followup is so good because I never seen this type of Staff and Doctors, Daily they call to my wife give their medicine instructions and Food instructions and They Only Gives Successful Treatment and Again again Thanks to Sudha Fertility  Viluppuram",
      name: "Sanjay",
      title: "Patient",
    },
    {
  ...
  environment.`,
    ...
    {
      quote:
        "Hi iam ramya Ramkumar I came har treatment for  Viluppuram sudha hospital. I conceive now I have a cute baby iam so happy great thanks to  Viluppuram sudha hospital management and staff.specially thanks to Dr Nivasini mam and staff Maha sister Vanitha mam other sudha hospital all staff thanks for  Viluppuram sudha hospital....",
      name: "RAM KUMAR",
      title: "Patient",
    },
    {
    ...
    <>
      <div className="relative w-full min-h-[850px] md:min-h-[600px] lg:min-h-[600px]">
        ...
        <div className="absolute -bottom-80 lg:-bottom-64 w-full ">
          <InfiniteMovingCardsDemo reviews={ViluppuramReview} />
        </div>
        <div
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <h3 className="text-[#173366] mt-3 font-semibold">
                        Best Fertility Treatments in  Viluppuram:
                      </h3>
                      <p className="mt-3 text-gray-600">
                ...
                <section id="specialists">
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      Our Fertility Specialist in  Viluppuram
                      </h3> */}
                      ...
                      <p className="text-gray-600 mt-3">
                        Dr. U Soundharya Nivasini, a fertility consultant at Sudha Fertility Centre,  Viluppuram, brings expertise honed through DNB (Obstetrics & Gynaecology) training at Meenakshi Mission Hospital and Research Centre, Madurai. With a track record of over 60 successful IUI procedures and consultations with more than 1000 patients, Dr. Nivasini consistently garners praise for her compassionate care and empowering guidance.
                      </p> */}
                    </div>
                  </motion.div>
      ...
      <section>
        ...
        <GallerySlider items={villupuramVideos} />
