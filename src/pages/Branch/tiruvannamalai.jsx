...
import SudhaAbout from "@/assets/branch/tiruvannamalai/tiruvannamalai_about.webp";
...
function TiruvannamalaiPage() {
  ...
  const tiruvannamalai = [
    {
      quote:
        "Staffs apoorach good Dr rajasree mam explanation very clear and good. Nice environment",
      name: "Soundari Venkatesan",
      title: "Patient",
    },
    {
      quote:
        "Wonderful experience Today I met Most senior Dr dhanabakkiyam mam Thank you so much Really very happy and hopeful for sudha hospital tv malai",
      name: "Badhmavathi",
      title: "Patient",
    },
    {
      quote:
        "Highly recommend Today I visited sudha hospital camp I met Dr dhanabakkiyam mam , mam speech very good I hope the sudha hospital",
      name: "Navanitham Rani",
      title: "Patient",
    },
    {
      quote:
        "Today I visited tv malai camp Nice experience",
      name: "Thalaiva Mahi",
      title: "Patient",
    },
    {
    ...
    <>
      <div className="relative w-full min-h-[850px] md:min-h-[600px] lg:min-h-[600px]">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center">
                  ...
                  >
                    ...
                    <p className="mt-4 text-[22px] leading-[1.6]">
                      Fertility care that supports in your parenthood journey.
                    </p>
                    <Button
                      styleClass="mt-6"
        ...
        <div className="absolute -bottom-80 lg:-bottom-64 w-full ">
          <InfiniteMovingCardsDemo reviews={tiruvannamalai} />
        </div>
        <div
            ...
            <div className="w-full pe-5">
              ...
              <ScrollMotion>
                <section id="about" className="  pt-2">
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <p className="text-gray-600 mt-3">
                        In the fast-paced world, infertility is considered to be a common issue. But it still affects the lives of many families. Each case has unique challenges, and finding the root cause of the problem is crucial. With the right support, you can make your dream of parenthood a reality. From young to older couples, our success story is marked by consistently high success.
                      </p>
                      <h3 className=" text-[#173366] mt-3 font-semibold">
                        Best Fertility Treatments in Tiruvannamalai:
                      </h3>
                      <p className="text-gray-600 mt-3">
                        As a leading IVF Centre in Tiruvannamalai, we offer advanced IVF treatments and other reproductive technologies to support your journey to parenthood.
                      </p>
                    </div>
                  ...
                  <motion.div>
                    <p className="text-gray-600 mt-3">
                      Our experienced specialists and state-of-the-art facilities are dedicated to offering you the best care and support.
                    </p>
                  </motion.div>
                  ...
                  >
                    <p className=" mt-3 mb-3 text-gray-600">
                      With the best IVF doctors, we offer the following world-class treatments
                    </p>
                    ...
                    <p className="mt-3 text-gray-600">
                      and other gynaec-related surgeries like C-section, Laparoscopy, Hysteroscopy, SSG, Cervical cerclage, Cyst and fluid aspiration, Myomectomy, ERA, OBS as well as other fertility preservation processes are performed by the best fertility doctors in Tiruvannamalai.
                    </p>
                    ...
                    <h3 className=" text-[#173366] mt-3 font-semibold">
                      Why Sudha Fertility Centre is the Best Fertility Centre in Tiruvannamalai?
                    </h3>
                    <p className="mt-3 text-gray-600">
                      We understand the emotional and physical challenges you go through facing infertility issues. At our fertility hospital in Tiruvannamalai, our compassionate and dedicated team is committed to guiding you through every step of your parenthood journey with personalized support and expert care.
                    </p>
                    <p className="mt-3 text-gray-600">
                      As the best IVF hospital in Tiruvannamalai, we promise to make your journey to becoming a parent as hopeful and successful as possible.  Let us help you turn your dreams of parenthood into reality!
                    </p>
                  </motion.div>
                ...
                <section id="facilities">
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <p className=" text-gray-600 mt-3">
                        Known as the best fertility hospital in Tiruvannamalai, Sudha Fertility Centre integrates state-of-the-art technology with compassionate care. Our commitment is to guide you through every moment of your parenthood journey with personalised attention.
                      </p>
                      <ul className="text-gray-600 mt-3 list-disc pl-4 leading-[2.2]">
                      ...
                      <div className="mt-5 rounded-lg space-y-6">
                        ...
                        <div className="flex items-start lg:space-x-4 sm:space-x-1 space-x-1">
                          ...
                          <div>
                            ...
                            <p className="font-semibold">
                              C/O, Nalam Hospital, First Floor, 5/2A/9th Street, Maanthopu, Polur Road, Opposite Hotel Vijay Park, Tiruvannamalai, Tamil Nadu - 606601.
                            </p>
                            <Link href="https://maps.app.goo.gl/LUcDVC633fxJ3Ltw7">
