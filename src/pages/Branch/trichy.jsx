    ...
    <>
      <div className="relative w-full min-h-[850px] md:min-h-[600px] lg:min-h-[600px]">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center">
                  ...
                  >
                    ...
                    <h1 className="font-bold mt-4">
                      ...
                      <span className="text-[#FDCB58]">Trichy</span>
                    </h1>
                    <p className="mt-4 text-[22px] leading-[1.6]">
                      Helping you overcome fertility problems with advanced fertility care.
                    </p>
                    <Button
                      styleClass="mt-6"
        ...
        <div className="absolute -bottom-80 lg:-bottom-64 w-full ">
          <InfiniteMovingCardsDemo reviews={trichy} />
        </div>
        <div
                ...
                <section id="about" className="  pt-2">
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <p className=" mt-3  text-gray-600">
                        Sudha Fertility Centre launched its branch in Trichy in 2020. As the best fertility centre in Trichy, we offer specialised, compassionate care at every stage of your parenthood journey. Our experienced team is passionate about supporting you through every step, ensuring that your dream of having a baby becomes a reality.
                      </p>
                      <h3 className=" text-[#173366] mt-3 font-semibold">
                        Best Fertility Treatments in Trichy:
                      </h3>
                      <p className="mt-3  text-gray-600">
                        Offering exceptional fertility treatments in Trichy, Sudha Fertility Centre is renowned for providing expert fertility services. Our dedicated specialists are committed to helping you overcome infertility, offering personalised treatments to support your path to becoming a parent.
                      </p>
                    </div>
                  ...
                  >
                    <p className="mt-3 mb-3  text-gray-600">
                      As the best fertility hospital in Trichy, Sudha Fertility Centre specialises in the following treatments,
                    </p>
                    ...
                    <p className="mt-3  text-gray-600">
                      and other gynaec-related surgeries like C-section, Laparoscopy, Hysteroscopy, SSG, Cervical cerclage, Cyst and fluid aspiration, Myomectomy, ERA, OBS as well as other fertility preservation processes are performed by the best fertility doctors in Trichy.
                    </p>
                    ...
                    <h3 className=" text-[#173366] mt-3 font-semibold">
                      Why Sudha Fertility Centre is the Best Fertility Centre in Trichy?
                    </h3>
                    <p className="mt-3  text-gray-600">
                      At Sudha Fertility Centre in Trichy, we have brightened the lives of numerous families who have longed for a child. From young couples just starting their journey together to older couples who have waited years for this moment, we’ve been part of their story. As the foremost fertility hospital in Trichy, we ensure that every patient receives world-class care and enjoys every step of their path to parenthood.
                    </p>
                    <p className="mt-3  text-gray-600">
                      Our fertility centre in Trichy has earned a trusted reputation for consistently delivering hope and happiness to families facing complex fertility challenges, turning their dreams into reality. With the expertise of the best fertility specialists in Trichy, many couples who have been yearning for a child for years have been blessed with babies, making their dream of parenthood come true at Sudha Fertility Centre.
                    </p>
                  </motion.div>
                ...
                <section id="facilities">
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <p className="mt-3  text-gray-600">
                        Sudha Fertility Centre in Trichy offers a warm and supportive environment and cutting-edge fertility treatments to help couples on their journey to parenthood. Our goal is to turn your dream of parenthood into a reality through advanced fertility treatments and state-of-the-art facilities, ensuring excellence at every step of your journey.
                      </p>
                      <ul className="text-gray-600 mt-3 list-disc pl-4 leading-[2.2]">
                    ...
                    <div className="w-full lg:w-1/2 mt-5">
                      <ImageSlider images={Trichy.Facilities.TrichyFac} />
                    </div>
                  </motion.div>
                ...
                <section id="specialists">
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-gray-600 mt-3">MBBS, DGO </p>
                      <p className="text-[#000000] mt-3">
                        Fertility Consultant / Gynaecologist
                      </p>
                      <p className="text-gray-600 mt-3">
                        Dr. Uma Shankari, MBBS, DGO, serves as a Fertility Consultant/Gynecologist at Sudha Fertility Centre, Trichy. With extensive experience spanning 5 years, she has performed over 1200 ICSI, 1200 IUI, and 900 IVF procedures, earning praise from over 10,000 satisfied patients. Dr. Shankari’s expertise also extends to completing more than 500 laparoscopic, 300 hysteroscopic, and other related procedures, ensuring the highest standard of care for her patients.
                      </p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    {/* <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-gray-600 mt-3">MBBS, MD (OG) </p>
                      <p className="text-[#000000] mt-3">
                        Fertility Consultant / Gynaecologist
                      </p>
                      <p className="text-gray-600 mt-3">
                      ...
                      <div className="mt-5 rounded-lg space-y-6">
                        ...
                        <div className="flex items-start lg:space-x-4 sm:space-x-1 space-x-1">
                          ...
                          <div>
                            ...
                            <Link href="https://maps.app.goo.gl/jP1sDSHqVXsXmdvK8">
