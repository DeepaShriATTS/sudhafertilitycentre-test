...
import Hospital from "@/assets/branch/tenali/tenali.webp";
import VijayaVani from "@/assets/branch/tenali/VijayaVani.jpg";
...
import { Ambattur, Tenalis } from "@/middleware/imagesroute";
...
function Tenali() {
  ...
  const toggleViewMore = () => {
    if (showAll) {
      ...
      setVisibleCount(Tenalis.faqs.length); // Show all FAQs
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center">
                  ...
                  >
                    ...
                    <h1 className="font-bold mt-4">
                      ...
                      <span className="text-[#FDCB58]">Tenali</span>
                    </h1>
                    <p className="mt-4 text-[22px] leading-[1.6]">
                      Your Trusted Partner in Your Parenthood Journey with Expertise in Fertility Care
                    </p>
                    <Button
                      styleClass="mt-6"
                ...
                <section id="about" className="  pt-2">
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <p className="mt-3  text-gray-600">
                        Established in 2025, Sudha Fertility Centre in Tenali specializes in offering world-class reproductive solutions with the best fertility specialists in Tenali. Our commitment to helping couples achieve their dream of parenthood, even in the face of health challenges, has earned us recognition as the best fertility centre in Tenali.
                      </p>
                      <p className="mt-3  text-gray-600 ">
                        Backed with experience of more than 40+ Years, Sudha Fertility Centre is widely recognized as the leading fertility hospital in South India. With a record of delivering lakhs of healthy babies, Sudha Fertility Centre has earned a trustable name in fertility care.
                      </p>
                  ...
                  <motion.div>
                    ...
                    <h3 className="mt-3 text-[#173366] font-semibold">
                      Quality Fertility Treatments Offered at Tenali
                    </h3>
                    <p className="mt-3 mb-3 text-gray-600">
                      Being the best IVF centre in Tenali, Sudha Fertility Centre offers the best fertility solutions by the best fertility doctors in Tenali. Sudha Fertility Centre has helped couples from different age groups with complicated health conditions. We always make sure your parenthood journey is as happy as it should be.
                    </p>
                  ...
                  >
                    <p className="mt-3 mb-3 text-gray-600">
                      As the prominent fertility hospital in Tenali, we specialise in the following treatments,
                    </p>
                    ...
                    <p className="mt-3 text-gray-600">
                      and other gynaec-related surgeries like C-section, Laparoscopy, Hysteroscopy, SSG, Cervical cerclage, Cyst and fluid aspiration, Myomectomy, ERA, OBS, as well as other fertility preservation processes are performed by the best fertility doctors in Tenali.
                    </p>
                    ...
                    <h3 className=" text-[#173366] font-semibold mt-5">
                      Why Sudha Fertility Centre is the Best Fertility Hospital in Tenali?
                    </h3>
                    <p className="text-gray-600 mt-3">
                      Sudha Fertility Centre is led by a team of highly experienced fertility specialists who bring years of expertise in managing complex infertility cases with confidence and care. Recognised as the best IVF centre in Tenali, we are known for our clinical excellence, advanced infrastructure, and commitment to evidence-based treatment. Every couple receives a thorough diagnosis and a personalised treatment plan, ensuring clarity, comfort, and the highest standards of fertility care.
                    </p>
                    <p className="text-gray-600 mt-3">
                      Our strength lies in combining clinical expertise with timely intervention, ensuring that couples are supported at every stage of their journey. With transparent treatment options, ethical practices, and dedicated support, Sudha Fertility Centre continues to be the trusted choice for fertility care in Tenali.
                    </p>
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <p className="text-md text-gray-600 mt-3">
                        Sudha Fertility Centre in Tenali combines modern medical facilities with a quiet, reassuring atmosphere, creating the right setting for couples to receive fertility care that meets global standards.
                      </p>
                ...
                <section id="specialists">
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <h4 className="text-[20px] font-semibold mt-3 leading-[1.4]">
                        Chief Experts of Sudha Fertility Centre in Tenali
                      </h4>
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className=" text-gray-600 mt-3">
                        Dr. K. Vijaya Vani is a highly skilled Fertility Specialist at Sudha Fertility Centre, known for her methodical approach to reproductive care. With a strong foundation in Obstetrics and Gynaecology, she offers advanced fertility evaluations and treatment strategies tailored to each couple’s condition. Her commitment to clinical excellence, attention to detail, and ethical practice ensures that patients receive the highest standard of fertility care in a supportive environment.
                      </p>
                    </div>
                  </motion.div>
              ...
              <ScrollMotion>
                <section id="gallery">
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                  >
                    <ImageGrid images={Tenalis.gallery} />
                  </motion.div>
                      ...
                      <div className=" rounded-lg space-y-6 mt-5">
                        ...
                        <div className="flex items-start lg:space-x-4 sm:space-x-1 space-x-1">
                          ...
                          <div>
                            ...
                            <p className="font-semibold">
                              V Cardiac and Multi Speciality Hospital, C/o, TB Rd, Kothapet, Ramalingeswara Pet, Tenali, Andhra Pradesh 522201
                            </p>
                            <Link href="https://maps.app.goo.gl/w27JKa7Vzywvx5cy9">
      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-5xl mx-auto px-4 py-16 sm:px-6 lg:px-8 h-full">
          <section>
            ...
            {Tenalis.faqs.slice(0, visibleCount).map((faq, index) => (
              <FAQItem
                key={index}
            ...
            {Tenalis.faqs.length > 5 && ( // Ensure button is shown if there are more than 5 FAQs
