...
function VaniyambadiPage() {
  ...
  return (
    ...
    //                   VANAKKAM Vaniyambadi
    //                 </h2>
    //                 <h1 className="font-bold mt-4">
    //                   Best Fertility Centre In{" "}
    //                   <br className="hidden sm:block" />
    //                   <span className="text-[#FDCB58]">Vaniyambadi</span>
    //                 </h1>
    //                 <p className="mt-4 text-[22px] leading-[1.6]">
    //                   Hopeful Beginnings with Affordable Fertility Care in Vaniyambadi
    //                 </p>
    //                 <Button
    //                   styleClass="mt-6"
    ...
    //                     Since opening its doors, Sudha Fertility Centre in Vaniyambadi has redefined fertility care for couples facing challenges in conceiving. Recognised as the best fertility centre in Vaniyambadi, our commitment lies in delivering ethical, technology-led treatments with warmth and empathy. Couples choose us not just for our reputation but for the genuine support and medical excellence they experience at every stage.
    //                   </p>
    //                   <p className=" mt-3 text-gray-600">
    //                     Built on a foundation of innovation and care, our centre serves families in and around Vaniyambadi with tailored fertility solutions. Our team of fertility experts, embryologists, and nurses work together to guide every couple through a confident and informed journey to parenthood.
    //                   </p>
    ...
    //                   Advanced Fertility Treatments in Vaniyambadi
    //                 </h3>
    //                 <p className="mt-3 text-gray-600">
    //                   As the best IVF centre in Vaniyambadi, Sudha Fertility Centre offers a comprehensive range of reproductive treatments designed around your fertility profile. Our treatment plans are personalised based on age, medical history, and fertility health.
    //                 </p>
    //                 <p className="mt-3 text-gray-600">
    //                   Recognized as the best IVF hospital in Vaniyambadi, Sudha Fertility Centre provides advanced fertility treatments with a high success rate and specializes in assisted reproductive technologies such as,
    //                 </p>
    ...
    //                 </ul>
    //                 <p className="mt-3 text-gray-600">
    //                   and other gynae-related surgeries like C-section, Laparoscopy, Hysteroscopy, SSG, Cervical cerclage, Cyst and fluid aspiration, Myomectomy, ERA, OBS, as well as other fertility preservation processes are performed by the best fertility doctors in Vaniyambadi.
    //                 </p>
    ...
    //                   Why Sudha Fertility Centre is the Best Fertility Hospital in Vaniyambadi?
    //                 </h3>
    //                 <p className="mt-3 text-gray-600">
    //                   Sudha Fertility Centre has earned its name as the best IVF hospital in Vaniyambadi by consistently delivering personalised treatments that focus on long-term reproductive health, not just short-term outcomes.
    //                 </p>
    //                 <ul className="text-md text-gray-600 list-disc pl-4 leading-[2.2]">
    //                   <li className=" pt-2 leading-[1.6]"> <h4 className=" text-black font-semibold mt-3 mb-2">Precision-Driven Protocols:

    //                   </h4>
    //                     Designed using global best practices and customised for every patient
    //                   </li>

    //                   <li className=" pt-2 leading-[1.6]"> <h4 className=" text-black font-semibold mt-3 mb-2">Clarity at Every Stage:
    //                   </h4>
    //                     We believe in complete transparency regarding treatment, pricing, and progress
    //                   </li>


    //                   <li className=" pt-2 leading-[1.6]"> <h4 className=" text-black font-semibold mt-3 mb-2"> Next-Gen IVF Lab:
    //                   </h4>
    //                     Modern facilities supporting cryopreservation, embryo monitoring, and genetic screening
    //                   </li>

    //                   <li className=" pt-2 leading-[1.6]"> <h4 className=" text-black font-semibold mt-3 mb-2"> Expert Doctors:
    //                   </h4>
    //                     Our reproductive specialists and embryologists bring years of focused experience in infertility care
    //                   </li>


    //                   <li className=" pt-2 leading-[1.6]"> <h4 className=" text-black font-semibold mt-3 mb-2">  Quick Access to Care:
    //                   </h4>
    //                     Reduced wait times and simplified scheduling to enhance treatment flow
    //                   </li>

    //                   <li className=" pt-2 leading-[1.6]"> <h4 className=" text-black font-semibold mt-3 mb-2"> Emotional Support Services:
    //                   </h4>
    //                     Psychological counselling and wellness resources available for all patients
    //                   </li>
    //                 </ul>
    //                 <p className="mt-3 text-gray-600">Through our consistent outcomes and supportive systems, we continue to stand as the best IVF centre in Vaniyambadi, trusted by couples from across Tamil Nadu. </p>
    //               </motion.div>
    ...
    //                     As a fully equipped fertility centre, our Vaniyambadi branch is designed to deliver exceptional patient experiences, medically, emotionally, and logistically. From diagnostics to post-treatment care, everything is under one roof.
    //                   </p>
    //                   <ul className="text-md text-gray-600 mt-3 list-disc pl-4 leading-[2.2]">
    //                     <li>24/7 In-House Pharmacy Services </li>
    //                     <li>Dedicated Labour Suite for Natural Births </li>
    //                     <li>Continuous Medical Support, Day and Night  </li>
    //                     <li>Expert Team Across Multiple Specialties </li>
    //                     <li>Comprehensive Diagnostic and Imaging Services  </li>
    //                     <li>Fully Equipped Surgical and Procedure Theatres  </li>
    //                     <li>Customized Fertility and Health Treatment Plans </li>
    //                   </ul>
    //                 </div>
    //                 <div className="w-full lg:w-1/2 mt-5">
    ...
    //                     Chief Experts of Sudha Fertility Centre in Vaniyambadi
    //                   </h3>
    ...
    //                 transition={{ duration: 0.5 }}
    //               >
    //                 <ImageGrid images={Vaniyambadi.gallery} />
    //               </motion.div>
    ...
    //                         </p>
    //                         <p className=" font-semibold">
    //                           277/1 JAMATH ROAD, 2nd St, opp. Government Hospital, Vaniyambadi, Tamil Nadu 635751
    //                         </p>
    //                         <Link href="">
    ...
    //         </h3>
    //         {Vaniyambadi.faqs.slice(0, visibleCount).map((faq, index) => (
    //           <FAQItem
    //             key={index}
    ...
    //           />
    //         ))}
    //         {Vaniyambadi.faqs.length > 5 && ( // Ensure button is shown if there are more than 5 FAQs
...
export default VaniyambadiPage;
