                ...
                <div className="flex flex-col lg:flex-row  justify-between items-center">
                  ...
                  >
                    ...
                    <p className=" mt-4 text-[22px] leading-[1.6]">
                      Lighting the way to your parenthood dreams.</p>
                    <Button
                      styleClass="mt-6"
            ...
            <div className="w-full pe-5">
              ...
              <ScrollMotion>
                <section id="about" className="  pt-2">
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <p className=" mt-3 text-gray-600">
                        Since 2019 Sudha Fertility Centre in Chennai has been understanding the emotional challenges of childless couples and has helped thousands of couples achieve their dream of parenthood with advanced fertility treatments. As one of the best fertility clinics in Chennai we have experienced fertility doctors in Chennai and the best IVF doctors in India. We are committed to our mission and ensure you have a happy and healthy parenthood. With high success rate Sudha Fertility Centre in Chennai is the best fertility centre in Chennai. Sudha Fertility Centre also offers fertility preservation options for those who want to save their reproductive potential for the future.
                      </p>
                  ...
                  <div className="mt-3">
                    <p className="mt-3 text-gray-600">
                      Sudha Fertility Centre in Chennai is the best fertility centre offering advanced fertility treatments and care. Our experienced fertility specialists give personalized care using latest assisted reproductive technologies for excellent outcomes and high success rates in IVF treatments. Our success rates reflect our commitment to deliver customized care to each individual.
                    </p>
                    ...
                    <p className="mt-3 text-md text-gray-600 ">
                      With the best IVF doctors and fertility doctors in Chennai we offer you the best fertility treatments in Chennai. We ensure you get personalized care and support throughout your parenthood journey. With advanced technology, care and support Sudha Fertility Centre in Chennai has helped many couples in their fertility journey by providing the best treatments and fertility care.
                    </p>
                  </div>
                  ...
                  >
                    <p className="mt-3 mb-2 text-md text-gray-600">
                      As the best Fertility centre providing best IVF treatment in Chennai Sudha Fertility Centre with high success rate is an expert in the following assisted reproductive technology treatments.
                    </p>
                    <ul className="text-md text-gray-600 mt-3 list-disc pl-4 leading-[2.2]">
                      <li>Normal Delivery - Natural Labour for Mothers</li>
                      <li>IVF - In Vitro Fertilization</li>
                      <li>IUI - Intrauterine Insemination. Egg collection usually happens on 12th day after ovarian stimulation which is a crucial step in preparing for embryo transfer. Assessing ovarian reserve is an important step in deciding the best fertility treatment for each patient. </li>
                      <li>ICSI - Intracytoplasmic Sperm Injection  </li>
                      <li>
                        IMSI - Intracytoplasmic Morphologically Selected Sperm Injection
                      </li>
                      <li>TESE - Testicular Sperm Extraction. Micro TESE is the best treatment for severe male factor infertility, especially azoospermia, as it focuses on extracting sperm from the testes effectively.  </li>
                    ...
                    <p className="mt-3  text-gray-600">
                      and other gynaec-related surgeries like C-section, Laparoscopy, Hysteroscopy, SSG, Cervical cerclage, Cyst and fluid aspiration, Myomectomy, ERA, OBS, as well as other fertility preservation processes and fertility treatments are performed by the experienced team of doctors in Chennai.  </p>
                    ...
                    <h2 className="  text-[24px] text-[#173366] font-semibold mt-5">
                      Why Sudha Fertility Centre is the best Fertility Centre in Chennai?
                    </h2>
                    <p className="text-gray-600 mt-3">
                      Our fertility hospital in Chennai is driven by the mission of helping every couple have a happy parenthood. Led by the best-skilled and experienced team of doctors in Chennai we have helped thousands of couples overcome complex fertility issues and welcome healthy babies.
                    </p>
                    <p className=" text-gray-600 mt-3">
                      As the best IVF centre in Chennai Sudha is a hope for thousands of childless families and helping them bring their baby's home. We ensure that from young couples to older couples who walk into our doors are treated with care and blessed with parenthood. We also offer genetic testing to identify any potential genetic disorders that could impact fertility and pregnancy outcomes. Our high success rate and expertise in providing the best IVF treatment makes us the trusted choice for couples who want to conceive.
                    </p>
                    <p className="mt-3 text-gray-600">
                      Our doctors and medical team at Sudha Fertility Centre in Chennai use advanced assisted reproductive technologies to offer excellent fertility solutions. With transparent pricing and personalized care, we focus on providing quality fertility treatments at affordable cost, making us the best fertility hospital in Chennai for couples who want effective fertility treatments and care on their parenthood journey. Our commitment to excellence has given us unparalleled success in helping couples have a baby.
                    </p>
              ...
              <ScrollMotion>
                <section id="facilities">
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <p className="text-md text-gray-600 mt-2">
                        Sudha Fertility Centre in Chennai is equipped with world-class facilities and highly skilled, experienced doctors, fertility specialists and technicians. We ensure you experience healthcare excellence and world-class fertility treatments at the best fertility clinic in Chennai as you start your parenthood journey. State-of-the-art Laboratories for IVF Treatment and embryo freezing, using latest technology to improve success rates and patient care. Our facilities also include cryopreservation services for long-term storage of embryos, eggs and sperm.
                      </p>
                      <ul className="text-md text-gray-600 mt-3 list-disc pl-4 leading-[2.2]">
                        <li>24/7 Pharmacy </li>
                        <li>Labour Room for Normal Delivery </li>
                  ...
                  <motion.div>
                    <h2 className="text-[24px] font-semibold  text-[#173366] mt-5">
                      Success Rate of Sudha Fertility Centre - The Best IVF Fertility Clinic
                    </h2>
                    <p className="mt-3 text-gray-600">
                      With over four decades of experience in fertility care Sudha Fertility Centre has delivered more than lakhs of healthy babies. With excellent success rates we have treated many couples with various fertility problems. We are with you every step of the fertility journey and help you for a positive and healthy pregnancy. We use preimplantation genetic diagnosis to ensure the health of embryos before transfer, increasing the chances of successful pregnancy. Our commitment to provide compassionate care, personalized treatment and world-class fertility solutions has made us a renowned fertility clinic in South India. Additionally, we offer oocyte freezing fertility treatment, a procedure for freezing women's eggs to preserve fertility for future use.
                    </p>
                    <p className="mt-3 text-gray-600">
                      Sudha Fertility Centre, the best IVF fertility centre has impressive success rates due to its advanced treatments. Our extensive experience in handling complicated fertility problems including female infertility and severe male factor infertility ensures effective solutions throughout the IVF cycle. We are dedicated to convert challenges into joyful parenthood experiences with precision and care. With focus on positive pregnancy outcomes, we provide care that supports couples every step of the way. Our success is a testimony to our commitment to excellence and technology.
                    </p>

                    <p className="mt-3 text-gray-600">
                      Your parenthood journey is no longer a dream; we help you achieve it with fertility treatments. Book your appointment with Sudha Fertility Centre and start your parenthood journey.
                    </p>
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      <h2 className="mb-3 text-[24px] text-[#173366] font-semibold leading-[1.4]">
                        Fertility Doctors in <br /> Chennai
                      </h2>
                      ...
                      <div className=" rounded-lg space-y-6 mt-5">
                        ...
                        <div className="flex items-start lg:space-x-4 sm:space-x-1 space-x-1">
                          ...
                          <div>
                            ...
                            <p className="font-semibold">
                              No.940, EVR Periyar Road, Poonamalli High Road, (Opp) Old Dasprakash Hotel, Purasaiwalkkam, Chennai, Tamil Nadu  – 600084.
                            </p>
                            <Link href="https://maps.app.goo.gl/ooLkknzC2oPQDU7L9" >
