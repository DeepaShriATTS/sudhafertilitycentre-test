...
import { Ambattur, Karaikudis, Hyderabad } from "@/middleware/imagesroute";
...
function Karaikudi() {
  ...
  const toggleViewMore = () => {
    if (showAll) {
      ...
      setVisibleCount(Karaikudis.faqs.length); // Show all FAQs
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center">
                  ...
                  >
                    ...
                    <h1 className="font-bold mt-4">
                      ...
                      <span className="text-[#FDCB58]">Karaikudi</span>
                    </h1>
                    <p className="mt-4 text-[22px] leading-[1.6]">
                      Your Dream of Parenthood Deserves Compassionate Expertise
                    </p>
                    <Button
                      styleClass="mt-6"
                ...
                <section id="about" className="  pt-2">
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <p className="mt-3  text-gray-600">
                        With a dedication to delivering top-quality healthcare services in fertility and overall well-being, Sudha Fertility Centre has established a new branch in Karaikudi in 2023. Our remarkable progress stands as a testament to our commitment to realizing the dream of parenthood for all our esteemed clients in Karaikudi.
                      </p>
                      <p className="mt-3  text-gray-600 ">
                        At Sudha Fertility Centre, Karaikudi, we are committed to helping you start your journey to parenthood. With a trusted team of experienced doctors and friendly staff, we offer the care and support you need every step of the way. If you're trying to conceive, let us guide you with the right treatment. Book your consultation today and take the first step towards bringing your baby home.
                      </p>
                  ...
                  <motion.div>
                    ...
                    <h3 className="mt-3 text-[#173366] font-semibold">
                      Best Fertility Treatments in Karaikudi
                    </h3>
                    <p className="mt-3 mb-3 text-gray-600">
                      Equipped with the best fertility specialists and IVF doctors, Sudha Fertility Centre in Karaikudi offers a wide range of fertility solutions to couples facing fertility challenges. We provide comprehensive treatments and compassionate care to every couple visiting our hospital.
                    </p>
                  ...
                  >
                    <p className="mt-3 mb-3 text-gray-600">
                      As the best IVF centre in Karaikudi, Sudha Fertility Centre specialises in the following treatments,
                    </p>
                    ...
                    <p className="mt-3 text-gray-600">
                      and other gynaec-related surgeries like C-section, Laparoscopy, Hysteroscopy, SSG, Cervical cerclage, Cyst and fluid aspiration, Myomectomy, ERA, OBS, as well as other fertility preservation processes are performed by the best fertility doctors in Karaikudi.
                    </p>
                    ...
                    <h3 className=" text-[#173366] font-semibold mt-5">
                      Why Sudha Fertility Centre is the Best Fertility Centre in Karaikudi?
                    </h3>
                    <p className="text-gray-600 mt-3">
                      With the experience of four decades, we hold a record of helping lakhs of families achieve their parenthood dreams, including young to older couples with advanced treatments. Our commitment and excellence in the fertility industry have gained us the name of the best fertility hospital in Karaikudi and all over South India.
                    </p>
                    <p className="text-gray-600 mt-3">
                      With the best fertility doctors, Sudha Fertility Centre has delivered more than a lakh of healthy babies. Equipped with international facilities, experienced lab technicians, world-class technology, and personalised care, Sudha Fertility Centre is known as the leading IVF hospital in Karaikudi. We’re here to help you achieve your dream of parenthood into a reality.
                    </p>
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <p className="text-md text-gray-600 mt-3">
                        At Sudha Fertility Centre, our experienced team is committed to making your fertility journey both successful and reassuring. We combine advanced technology with personalised care to guide you every step of the way. With skilled doctors and supportive staff, we ensure you receive the best treatment at every step of your parenthood journey.
                      </p>
                ...
                <section id="specialists">
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <h4 className="text-[20px] font-semibold mt-3 leading-[1.4]">
                        Chief Experts of Sudha Fertility Centre in Karaikudi
                      </h4>
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className=" text-gray-600 mt-3">
                        Dr. Sudha Balaji is an experienced gynaecologist at Sudha Fertility Centre. Known for her patient-centric approach and clinical expertise, she is dedicated to offering comprehensive care for women at every stage of life. With her focus on providing accurate diagnosis, empathetic counselling, and tailored treatments, Dr. Sudha has earned the trust of countless women seeking expert guidance in reproductive and general gynaecological health.
                      </p>
                    </div>
                  </motion.div>
              ...
              <ScrollMotion>
                <section id="gallery">
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                  >
                    <ImageGrid images={Karaikudis.gallery} />
                  </motion.div>
                      ...
                      <div className=" rounded-lg space-y-6 mt-5">
                        ...
                        <div className="flex items-start lg:space-x-4 sm:space-x-1 space-x-1">
                          ...
                          <div>
                            ...
                            <p className="font-semibold">
                              Saali C/o, KMC Hospital, 42/1, Mudiyarasanar, near New Bus Stand Maruthupandiyar Nagar, Karaikudi, Tamil Nadu 630001
                            </p>
                            <Link href="https://maps.app.goo.gl/DKpmahvw2cm3cEAc7">
      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-5xl mx-auto px-4 py-16 sm:px-6 lg:px-8 h-full">
          <section>
            ...
            {Karaikudis.faqs.slice(0, visibleCount).map((faq, index) => (
              <FAQItem
                key={index}
            ...
            {Karaikudis.faqs.length > 5 && ( // Ensure button is shown if there are more than 5 FAQs
