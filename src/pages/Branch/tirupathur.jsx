...
// import SudhaAbout from "@/assets/branch/ Tirupathur/ Tirupathur_about.webp";
import { motion } from "framer-motion";
import Pradeepa from "@/assets/branch/ambatur/pradeepa.webp";
// import Hospital from "@/assets/branch/ Tirupathur/ Tirupathur.webp";
// import SoundharyaNivasini from "@/assets/branch/ Tirupathur/SoundharyaNivasini.webp";
...
import { Ambattur, Tirupathur } from "@/middleware/imagesroute";
...
function TirupathurPage() {
  ...
  const toggleViewMore = () => {
    if (showAll) {
      ...
      setVisibleCount(Tirupathur.faqs.length); // Show all FAQs
  ...
  const TirupathurReview = [
    {
      quote:
        `Very very thanks to  Tirupathur sudha hospital and nursing staff. Today my best day my life my wife has positive result( isci). Best fertility centre in  Tirupathur`,
      name: "Girija ganesan",
      title: "Patient",
    },
    {
    ...
    {
      quote:
        `This is Muthu from Tirupathur. I knew the Sudha hospital through my friend. My daughter got married at 2019. She don't have child. So we went to Sudha hospital  Tirupathur for my daughter's fertility treatment. Now she delivered a boy baby. I really happy with my boy. I want to thank for each and every staff in this hospital.
  Once again I thank the doctor mam she gave hope to my family and my daughter. Nowadays we're very happy with my grandson. I thanks the Sudha hospital management with gratefulness.`,
    ...
    {
      quote:
        "Sudha hospital    Tirupathur  branch  last 5years no kids  iam  send it sudha hospital  Tirupathur.   treatment   started  my saide vry improve  iam vry confidant  in my self  vry good exlent service counselling   also clearly  staff vry caring thank god",
      name: "Bharatha Selvi",
      title: "Patient",
    },
    {
    ...
    {
      quote:
        `😍💘👨‍👩‍👧Best hospital in  Tirupathur for fertility treatment. The care is top notch and positive vibes are best. Multiple visit on other hospitals are didn't work for us but here got good news in 1st month treatment itself.
  Got my princess after 5 yers through IUI on 25th Mar'23. Thanks a lot to Nivashini Mam, Archana, Dhanalakshmi and Vanitha Mam🙏💘😍👨‍👩‍👧. Try visit once then you will feel good vibes. ⚡`,
    ...
    {
      quote:
        "Sudha hospital  Tirupathur  dr  staff good service   my sister 15 years no chid    iam going on sudha hospital  Dr nivashni staff vry good caring  treatment vry satisfied thank you sudha hospital  Tirupathur  branch",
      name: "ᴠꜱ ᴄʀᴇᴀᴛɪᴏɴ",
      title: "Patient",
    },
    {
    ...
    {
      quote:
        "After 20 years we got a girl baby and Then my wife and family got so happy and it' s given by Sudha Fertility  Tirupathur Gift Because Me and my wife got treatment above 10 different IVF hospital But waste of Time and Money only because all treatment goes to failure 😭😭😭 and never I can't forget a sudha Fertility Centre  Tirupathur with the help of Madurai Sudha Hospital Also , because all staff are treated like a Family and Their Followup is so good because I never seen this type of Staff and Doctors, Daily they call to my wife give their medicine instructions and Food instructions and They Only Gives Successful Treatment and Again again Thanks to Sudha Fertility  Tirupathur",
      name: "Sanjay",
      title: "Patient",
    },
    {
  ...
  environment.`,
    ...
    {
      quote:
        "Hi iam ramya Ramkumar I came har treatment for  Tirupathur sudha hospital. I conceive now I have a cute baby iam so happy great thanks to  Tirupathur sudha hospital management and staff.specially thanks to Dr Nivasini mam and staff Maha sister Vanitha mam other sudha hospital all staff thanks for  Tirupathur sudha hospital....",
      name: "RAM KUMAR",
      title: "Patient",
    },
    {
    ...
    <>
      <div className="relative w-full min-h-[850px] md:min-h-[600px] lg:min-h-[600px]">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center">
                  ...
                  >
                    ...
                    <h1 className="font-bold mt-4">
                      ...
                      <span className="text-[#FDCB58]"> Tirupathur</span>
                    </h1>
                    <p className="mt-4 text-[22px] leading-[1.6]">
                      Your hope for parenthood finds a home here.
        ...
        <div className="absolute -bottom-80 lg:-bottom-64 w-full ">
          <InfiniteMovingCardsDemo reviews={TirupathurReview} />
        </div>
        <div
                ...
                <section id="specialists">
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <h3 className="text-[20px] font-semibold mt-3 leading-[1.4]">
                        Chief Experts of Sudha Fertility Centre in  Tirupathur
                      </h3>
                      <h3 className="text-[20px] font-semibold mt-3 leading-[1.4]">
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      Our Fertility Specialist in  Tirupathur
                      </h3> */}
                      ...
                      <p className="text-gray-600 mt-3">
                        Dr. U Soundharya Nivasini, a fertility consultant at Sudha Fertility Centre,  Tirupathur, brings expertise honed through DNB (Obstetrics & Gynaecology) training at Meenakshi Mission Hospital and Research Centre, Madurai. With a track record of over 60 successful IUI procedures and consultations with more than 1000 patients, Dr. Nivasini consistently garners praise for her compassionate care and empowering guidance.
                      </p> */}
                    </div>
                  </motion.div>
              ...
              <ScrollMotion>
                <section id="gallery">
                  ...
                  {/* <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                  >
                    <ImageGrid images={ Tirupathur.gallery} />
                  </motion.div> */}
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
      ...
      <div className="container mx-auto">
        <div className="max-w-5xl mx-auto px-4 py-16 sm:px-6 lg:px-8 h-full">
          <section>
            ...
            {Tirupathur.faqs.slice(0, visibleCount).map((faq, index) => (
              <FAQItem
                key={index}
            ...
            {Tirupathur.faqs.length > 5 && ( // Ensure button is shown if there are more than 5 FAQs
