...
// import SudhaAbout from "@/assets/branch/ Tindivanam/ Tindivanam_about.webp";
import { motion } from "framer-motion";
import Pradeepa from "@/assets/branch/ambatur/pradeepa.webp";
// import Hospital from "@/assets/branch/ Tindivanam/ Tindivanam.webp";
// import SoundharyaNivasini from "@/assets/branch/ Tindivanam/SoundharyaNivasini.webp";
...
import { Ambattur, Tindivanam } from "@/middleware/imagesroute";
...
function TindivanamPage() {
  ...
  const toggleViewMore = () => {
    if (showAll) {
      ...
      setVisibleCount(Tindivanam.faqs.length); // Show all FAQs
  ...
  const TindivanamReview = [
    {
      quote:
        `Very very thanks to  Tindivanam sudha hospital and nursing staff. Today my best day my life my wife has positive result( isci). Best fertility centre in  Tindivanam`,
      name: "Girija ganesan",
      title: "Patient",
    },
    {
    ...
    {
      quote:
        `This is Muthu from Tindivanam. I knew the Sudha hospital through my friend. My daughter got married at 2019. She don't have child. So we went to Sudha hospital  Tindivanam for my daughter's fertility treatment. Now she delivered a boy baby. I really happy with my boy. I want to thank for each and every staff in this hospital.
  Once again I thank the doctor mam she gave hope to my family and my daughter. Nowadays we're very happy with my grandson. I thanks the Sudha hospital management with gratefulness.`,
    ...
    {
      quote:
        "Sudha hospital    Tindivanam  branch  last 5years no kids  iam  send it sudha hospital  Tindivanam.   treatment   started  my saide vry improve  iam vry confidant  in my self  vry good exlent service counselling   also clearly  staff vry caring thank god",
      name: "Bharatha Selvi",
      title: "Patient",
    },
    {
    ...
    {
      quote:
        `😍💘👨‍👩‍👧Best hospital in  Tindivanam for fertility treatment. The care is top notch and positive vibes are best. Multiple visit on other hospitals are didn't work for us but here got good news in 1st month treatment itself.
  Got my princess after 5 yers through IUI on 25th Mar'23. Thanks a lot to Nivashini Mam, Archana, Dhanalakshmi and Vanitha Mam🙏💘😍👨‍👩‍👧. Try visit once then you will feel good vibes. ⚡`,
    ...
    {
      quote:
        "Sudha hospital  Tindivanam  dr  staff good service   my sister 15 years no chid    iam going on sudha hospital  Dr nivashni staff vry good caring  treatment vry satisfied thank you sudha hospital  Tindivanam  branch",
      name: "ᴠꜱ ᴄʀᴇᴀᴛɪᴏɴ",
      title: "Patient",
    },
    {
    ...
    {
      quote:
        "After 20 years we got a girl baby and Then my wife and family got so happy and it' s given by Sudha Fertility  Tindivanam Gift Because Me and my wife got treatment above 10 different IVF hospital But waste of Time and Money only because all treatment goes to failure 😭😭😭 and never I can't forget a sudha Fertility Centre  Tindivanam with the help of Madurai Sudha Hospital Also , because all staff are treated like a Family and Their Followup is so good because I never seen this type of Staff and Doctors, Daily they call to my wife give their medicine instructions and Food instructions and They Only Gives Successful Treatment and Again again Thanks to Sudha Fertility  Tindivanam",
      name: "Sanjay",
      title: "Patient",
    },
    {
  ...
  environment.`,
    ...
    {
      quote:
        "Hi iam ramya Ramkumar I came har treatment for  Tindivanam sudha hospital. I conceive now I have a cute baby iam so happy great thanks to  Tindivanam sudha hospital management and staff.specially thanks to Dr Nivasini mam and staff Maha sister Vanitha mam other sudha hospital all staff thanks for  Tindivanam sudha hospital....",
      name: "RAM KUMAR",
      title: "Patient",
    },
    {
    ...
    <>
      <div className="relative w-full min-h-[850px] md:min-h-[600px] lg:min-h-[600px]">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center">
                  ...
                  >
                    ...
                    <h1 className="font-bold mt-4">
                      ...
                      <span className="text-[#FDCB58]"> Tindivanam</span>
                    </h1>
                    <p className="mt-4 text-[22px] leading-[1.6]">
                      Leading you through the pathway to Parenthood.
                    </p>
                    <Button
                      styleClass="mt-6"
        ...
        <div className="absolute -bottom-80 lg:-bottom-64 w-full ">
          <InfiniteMovingCardsDemo reviews={TindivanamReview} />
        </div>
        <div
                ...
                <section id="about" className="  pt-2">
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <p className="mt-3 text-gray-600">
                        Sudha Fertility Centre in Tindivanam is built to serve couples with both advanced medical care and compassionate guidance. Our specialists are committed to making parenthood possible by combining proven reproductive techniques with personalized counselling. Every couple’s journey is unique, and our team ensures that treatments are tailored to individual needs.
                      </p> <br />
                      <p className="mt-3 text-gray-600">
                        With advanced technology and a patient‑first approach, Tindivanam’s branch is a place where families can begin their journey with confidence. Every consultation is detailed, every explanation is transparent, and every step is taken with empathy. Couples are never left feeling uncertain; they are empowered with knowledge and reassured with care.
                      </p>
                      <h3 className="text-[#173366] mt-3 font-semibold">
                        Best Fertility Treatments Offered  in  Tindivanam:
                      </h3>
                      <p className="mt-3 text-gray-600">
                        At Tindivanam, fertility care is delivered with clarity and confidence. Couples are guided through every treatment option, with doctors explaining how each procedure works and what outcomes to expect. We believe that informed decisions lead to better results, so our specialists ensure that no question goes unanswered. Treatments are carefully planned, never rushed, and tailored to suit individual medical needs. From basic fertility solutions to advanced reproductive techniques, our branch provides comprehensive care under one roof. This approach ensures that couples feel supported at every stage of their journey.
                      </p>
                  ...
                  >
                    <p className="mt-3 mb-3 text-gray-600">
                      Our primary fertility treatments include various options to support individuals on their journey to parenthood:
                    </p>
                    ...
                    <ul className="text-gray-600 mt-3 list-disc pl-4 leading-[2.2]">
                      ...
                      <li>
                        ...
                        <span>
                          A comprehensive process that aids conception using laboratory techniques.
                      ...
                      <li>
                        ...
                        <span>
                          A procedure that places sperm directly into the uterus to enhance the chances of pregnancy.
                        </span>
                      </li>
                      ...
                      <li>
                        ...
                        <span>
                          A specialized method where a single sperm is injected directly into an egg to promote fertilization.
                      ...
                      <li>
                        ...
                        <span>
                          An advanced version of ICSI that uses carefully selected sperm for improved results.
                        </span>
                      </li>
                      ...
                      <li>
                        ...
                        <span>
                          A procedure to extract sperm directly from the testicles for fertility treatments.
                      ...
                      <li>
                        ...
                        <span>
                          A technique that collects sperm from the epididymis, broadening fertility options.
                        </span>
                      </li>
                      ...
                      <li>
                        ...
                        <span>
                          A method that assists embryos in implanting more effectively into the uterine lining.
                      ...
                      <li>
                        ...
                        <span>
                          A treatment that uses the patient’s own blood cells to rejuvenate the ovaries and improve egg quality.
                        </span>
                      </li>
                      ...
                      <li>
                        ...
                        <span>
                          A process that involves implanting previously frozen embryos for future use.
                        </span>
                      </li>
                      ...
                      <li>
                        ...
                        <span>
                          A treatment that enhances the uterine lining, increasing the likelihood of implantation.
                    ...
                    <p className="mt-3 text-gray-600">
                      Additionally, we provide other gynaecological surgeries such as Laparoscopy, SSG, Cervical cerclage, C-section, Myomectomy, OBS, ERA, cyst and fluid aspiration, along with various fertility preservation methods.
                    </p>
                    ...
                    <h3 className=" text-[#173366] font-semibold mt-3">
                      Why Sudha Fertility Centre is the Best Fertility Hospital in Tindivanam?

                    </h3>
                    <p className="mt-3 text-gray-600">
                      As a well-known fertility firm for renowned services and facilities, Sudha Fertility Centre has brought the same world-class treatments, modern technologies, and highly expertised doctors to the Tindivanam branch. Equipped with specialized technologies and high success rates, our fertility experts deliver exceptional counselling and treatment options for every couple.

                    </p>
                    <ul className="text-gray-600 mt-3 list-disc pl-4 leading-[2.2]">

                      <li><strong>Cost-Effective Treatments:</strong> We provide fertility treatments at affordable prices, ensuring that high-quality care is accessible to all.</li>
                      <li><strong>Outstanding IVF Success Rates:</strong> Our success rates are bolstered by cutting-edge technology and rigorous quality control measures.</li>
                      <li><strong>Skilled Fertility Specialists:</strong> Our team consists of professionals with specialized training in reproductive medicine.</li>
                      <li><strong>Quick Diagnosis and Lab Reports:</strong> We prioritize reducing delays and stress through efficient diagnosis and timely lab results.</li>
                      <li><strong>Customized Treatment Plans:</strong> Our plans are specifically designed based on your unique diagnosis and medical history.</li>
                      <li><strong>Comprehensive Emotional and Clinical Support:</strong> We are committed to supporting you at every stage of your journey.</li>

                    </ul>

                    <p className="mt-3 text-gray-600">
                      So, in the end, it's not just about the treatment. Sudha Fertility Centre is a place where people feel cared for and makes us the trusted choice for fertility care in Tindivanam.
                    </p>
                  </motion.div>
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <p className=" text-gray-600 mt-3">
                        Sudha Fertility Centre in Tindivanam is dedicated to offering high-quality treatment, with every space designed to ensure that couples feel comfortable and at ease. That’s why patients across Tindivanam trust us not just for medical excellence, but for our human approach to care.
                      </p>
                      ...
                      <ul className="text-gray-600 mt-3 list-disc pl-4 leading-[2.2]">
                        ...
                        <li>Dedicated Medical Support Staff</li>
                        <li>Affordable Treatment Options</li>
                        <li>24/7 Pharmacy Services</li>
                        <li>Around-the-Clock Medical Care</li>
                      </ul>
                ...
                <section id="specialists">
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <h3 className="text-[20px] font-semibold mt-3 leading-[1.4]">
                        Chief Experts of Sudha Fertility Centre in  Tindivanam
                      </h3>
                      ...
                      <p className=" text-gray-600 mt-3 ">
                        Dr. S. Pradeepa Sudhakar is renowned for her outstanding clinical skills and extensive knowledge in fertility treatments and advanced reproductive technologies. With a strong emphasis on patient care and remarkable success rates, she has played a vital role in helping numerous couples fulfill their dreams of parenthood.

                      </p>
                      <div className="sm-block hidden">
                        <p className="text-md  text-gray-600 mt-3">
                          As Vice President of Sudha Fertility Centre, Dr. Pradeepa has successfully steered the organization’s expansion, growing to over 40 branches within just five years. Her dedication to medical excellence is matched by her empathetic counseling, offering essential support and guidance to patients throughout their fertility journeys.
                        ...
                        <ul className="text-gray-600 list-disc pl-4 mt-3 leading-[2.2]">
                          <li>Active member of the American Society for Reproductive Medicine (ASRM)</li>
                          <li>Active member of the European Society of Human Reproduction &amp; Embryology (ESHRE)</li>
                          ...
                          <li>Faculty member of the International Federation of Fertility Societies</li>
                        </ul>
                      </div>
                    </div>
                    <div className="w-full lg:w-1/2 mt-5">
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      Our Fertility Specialist in  Tindivanam
                      </h3> */}
                      ...
                      <p className="text-gray-600 mt-3">
                        Dr. U Soundharya Nivasini, a fertility consultant at Sudha Fertility Centre,  Tindivanam, brings expertise honed through DNB (Obstetrics & Gynaecology) training at Meenakshi Mission Hospital and Research Centre, Madurai. With a track record of over 60 successful IUI procedures and consultations with more than 1000 patients, Dr. Nivasini consistently garners praise for her compassionate care and empowering guidance.
                      </p> */}
                    </div>
                  </motion.div>
              ...
              <ScrollMotion>
                <section id="gallery">
                  ...
                  {/* <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                  >
                    <ImageGrid images={ Tindivanam.gallery} />
                  </motion.div> */}
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                      ...
                      <div className="mt-5 rounded-lg space-y-6">
                        ...
                        <div className="flex items-start lg:space-x-4 sm:space-x-1 space-x-1">
                          ...
                          <div>
                            ...
                            <p className="font-semibold">
                              No 55/1 B, Tindivanam-Marakkanam Rd, opp. to Fire station, Tindivanam, Tamil Nadu 604001
                            </p>
                            <Link href="https://maps.app.goo.gl/TWSo5z64sFzQAeCG7">
      ...
      <div className="container mx-auto">
        <div className="max-w-5xl mx-auto px-4 py-16 sm:px-6 lg:px-8 h-full">
          <section>
            ...
            {Tindivanam.faqs.slice(0, visibleCount).map((faq, index) => (
              <FAQItem
                key={index}
            ...
            {Tindivanam.faqs.length > 5 && ( // Ensure button is shown if there are more than 5 FAQs
