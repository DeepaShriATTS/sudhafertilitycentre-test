...
function PerambalurPage() {
  ...
  return (
    ...
    //                   <span className="text-[#FDCB58]">Perambalur</span>
    //                 </h1>
    //                 <p className="mt-4 text-[22px] leading-[1.6]">
    //                   World-Class Fertility Support, Now Affordable in Perambalur.
    //                 </p>
    //                 <Button
    //                   styleClass="mt-6"
    ...
    //                     Sudha Fertility Centre in Perambalur inaugurated in 2025 offers a perfect blend of advanced fertility treatments and personalised reproductive care. As the best fertility hospital in Perambalur, we are committed to transforming the parenthood journey with medical excellence and personal support. We combine clinical precision with compassion to provide ethical and result-oriented treatments for both male and female fertility issues.
    //                   </p>

    //                   <p className=" mt-3 text-gray-600">
    //                     Our Perambalur facility is staffed with experienced fertility specialists, embryologists, and dedicated nurses who work together to provide every couple with individual attention and consistent care.
    //                   </p>
    ...
    //                   World-class Fertility Treatments in Perambalur:
    //                 </h3>
    //                 <p className="mt-3 text-gray-600">
    //                   At Sudha Fertility Centre in Perambalur, we address a wide range of fertility challenges, whether you are starting out, have experienced previous setbacks, or are seeking advanced options. Every treatment is tailored based on individual needs, ensuring a balanced approach combining medical precision and emotional sensitivity.
    //                 </p>
    //                 <p className=" mt-3 mb-3 text-gray-600">
    //                   Recognized as the best IVF hospital in Perambalur, Sudha Fertility Centre provides advanced fertility treatments with a high success rate and specializes in assisted reproductive technologies such as,
    //                 </p>
    ...
    //                 </ul>
    //                 <p className="mt-3 text-gray-600">
    //                   and other gynae-related surgeries like C-section, Laparoscopy, Hysteroscopy, SSG, Cervical cerclage, Cyst and fluid aspiration, Myomectomy, ERA, OBS, as well as other fertility preservation processes are performed by the best fertility doctors in Perambalur.
    //                 </p>
    ...
    //                   Why Sudha Fertility Centre is the Best Fertility Hospital in Perambalur?
    //                 </h3>
    //                 <p className="mt-3 text-gray-600">
    //                   At Sudha Fertility Centre, we understand that each fertility journey is unique. That’s why we prioritise customised care plans, precise diagnostics, and proven medical protocols to increase your chances of successful conception. We are known as the best IVF centre in Perambalur region for offering the best treatments at an affordable cost without compromising on quality.
    //                 </p>
    //                 <ul className="text-md text-gray-600 list-disc pl-4 leading-[2.2]">
    //                   <li className=" pt-2 leading-[1.6]"> <h4 className=" text-black font-semibold mt-3 mb-2">Customised Clinical Strategies:

    //                   </h4>
    //                     Treatments built around your medical history, age, and specific fertility challenges.
    //                   </li>

    //                   <li className=" pt-2 leading-[1.6]"> <h4 className="text-black font-semibold mt-3 mb-2">Honest and Comprehensive Consultation:
    //                   </h4>
    //                     Every discussion is open, detailed, and focused on helping you make informed decisions.
    //                   </li>


    //                   <li className=" pt-2 leading-[1.6]"> <h4 className="text-black  font-semibold mt-3 mb-2"> Technologically Advanced Infrastructure:
    //                   </h4>
    //                     Equipped for high-precision fertility interventions and supported by continual innovation.
    //                   </li>

    //                   <li className=" pt-2 leading-[1.6]"> <h4 className=" text-black font-semibold mt-3 mb-2"> Professionals You Can Trust:
    //                   </h4>
    //                     Our Perambalur team includes seasoned consultants, embryologists, and nursing staff with deep expertise.
    //                   </li>


    //                   <li className=" pt-2 leading-[1.6]"> <h4 className=" text-black font-semibold mt-3 mb-2"> Punctual and Patient-Centric Care:
    //                   </h4>
    //                     We prioritise your time and comfort with structured appointments and efficient care pathways.
    //                   </li>

    //                   <li className=" pt-2 leading-[1.6]"> <h4 className=" text-black font-semibold mt-3 mb-2"> Mental and Emotional Support:
    //                   </h4>
    //                     Fertility journeys are personal, and we ensure you have psychological and emotional support whenever needed.
    //                   </li>
    //                 </ul>
    //               </motion.div>
    ...
    //                   </h3>
    //                   <p className="mt-3 text-gray-600">
    //                     As the best fertility centre in Perambalur, Sudha Fertility Centre is equipped with world-class amenities and international standard infrastructure. With modern architecture and comfort-focused interiors, patients feel cared for the moment they step in.
    //                   </p>
    ...
    //                     Chief Experts of Sudha Fertility Centre in Perambalur
    //                   </h3>
    ...
    //                 transition={{ duration: 0.5 }}
    //               >
    //                 <ImageGrid images={Perambalur.gallery} />
    //               </motion.div>
    ...
    //                         </p>
    //                         <p className="font-semibold">
    //                           C/o Ramasamy Hospital, No.80A, Palakarai, Vasanth & Co Opposite, Trichy main road, Perambalur - 621 220
    //                         </p>
    //                         <Link href="">
    ...
    //         </h2>
    //         {Perambalur.faqs.slice(0, visibleCount).map((faq, index) => (
    //           <FAQItem
    //             key={index}
    ...
    //           />
    //         ))}
    //         {Perambalur.faqs.length > 5 && ( // Ensure button is shown if there are more than 5 FAQs
