    ...
    <>
      <div className="relative w-full min-h-[850px] md:min-h-[600px] lg:min-h-[600px]">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center">
                  ...
                  >
                    ...
                    <p className="mt-4 text-[22px] leading-[1.6]">
                      Every step of your parenthood journey, guided by care and compassion.
                    </p>
                    <Button
                      styleClass="mt-6"
        ...
        <div className="absolute -bottom-80 lg:-bottom-64 w-full ">
          <InfiniteMovingCardsDemo reviews={vijayawada} />
        </div>
        <div
            ...
            <div className="w-full pe-5">
              ...
              <ScrollMotion>
                <section id="about" className="  pt-2">
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <p className="mt-3  text-gray-600">
                        Sudha Fertility Centre expanded to Vijayawada in 2023, offering unmatched fertility care. Recognized as the top fertility hospital in Vijayawada, we provide personalised and compassionate support to guide you at every stage of your parenthood journey. Our goal is to help turn your dreams of having a family into reality.
                      </p>
                      <p className="mt-3  text-gray-600">
                        With our experienced team, we are dedicated to providing the best fertility treatments with compassionate care and support at every step of your parenthood journey.
                      </p>
                  ...
                  >
                    <p className="mt-3  text-gray-600">
                      Equipped with the latest technology and a team of highly skilled fertility specialists in Vijayawada, we deliver advanced fertility treatments in Vijayawada to support you on your path to parenthood.
                    </p>
                    <p className="mb-3 mt-3  text-gray-600">
                      As the best IVF centre in Vijayawada, Sudha Fertility Centre specialises in the following treatments,
                    </p>
                    ...
                    <p className="mt-3 text-gray-600">
                      and other gynaec-related surgeries like C-section, Laparoscopy, Hysteroscopy, SSG, Cervical cerclage, Cyst and fluid aspiration, Myomectomy, ERA, OBS as well as other fertility preservation processes are performed by the best fertility doctors in Vijayawada.
                    </p>
                    ...
                    <h3 className=" text-[#173366] mt-3 font-semibold">
                      Why Sudha Fertility Centre is the Best Fertility Centre in Vijayawada?
                    </h3>
                    <p className="mt-3 text-gray-600">
                      Sudha Fertility Centre in Vijayawada has brought joy to countless families, fulfilling the dreams of those who have longed for a child. From young couples starting their life together to older couples longing for a child, we have been a part of their beautiful journey. As the leading IVF hospital in Vijayawada, we are committed to providing outstanding care and ensuring that every individual enjoys a fulfilling parenthood experience.
                    </p>
                    <p className="mt-3 text-gray-600">
                      At Sudha Fertility Centre, our mission is to support couples in their parenthood journey with the guidance of the best IVF doctors in Vijayawada. With a remarkable history of delivering lakhs of healthy babies at our various branches, we are honored to be known as the best fertility centre in Vijayawada.
                    </p>
                  </motion.div>
                  ...
                  >
                    <div className="w-full lg:w-1/2 mt-5">
                      ...
                      <p className=" text-gray-600 mt-3">
                        Sudha Fertility Centre in Vijayawada offers the best fertility treatments. With the world-class facilities and best fertility experts in Vijayawada, we are known as the best fertility hospital in Vijayawada.
                      </p>
                      <ul className="text-gray-600 mt-3 list-disc pl-4 leading-[2.2]">
                    ...
                    <div className="w-full lg:w-1/2 mt-5">
                      <ImageSlider images={Vijayawada.Facilities.VijayawadaFac} />
                    </div>
                  </motion.div>
                      ...
                      <div className="mt-5 rounded-lg space-y-6">
                        ...
                        <div className="flex items-start lg:space-x-4 sm:space-x-1 space-x-1">
                          ...
                          <div>
                            ...
                            <Link href="https://maps.app.goo.gl/eLWPXMvBPa4PvYgz9">
