/**
 * src/data/homeVideos.js
 *
 * Home page video data only.
 * Branch-specific video arrays remain in src/middleware/videosRoute.jsx
 * so existing branch imports are undisturbed.
 *
 * Splitting this out prevents the entire 69 KB videosRoute.jsx from being
 * parsed on every home page request just for 5 video objects.
 */

/**
 * Derives a YouTube HQ thumbnail URL from a video URL.
 * Handles youtu.be short links, youtube.com/watch, and embed URLs.
 *
...
/** @type {Array<{id: number, videoUrl: string, firstVideoUrl: string, title: string, description: string}>} */
