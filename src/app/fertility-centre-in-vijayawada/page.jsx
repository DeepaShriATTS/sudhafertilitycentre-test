...
export default function page() {
  ...
  return (
    <div>
      ...
      <Script
        id="breadcrumb-schema-vijayawada"
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "BRANCH",
                "item": "https://sudhafertilitycentre.com/fertility-centre-in-vijayawada"
              }
            ]
          })
        }}
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "What fertility treatments are available in Vijayawada?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "What is the cost of IVF in Vijayawada?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "What is the cost of fertility treatments in Vijayawada?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "How can I choose the best fertility hospital in Vijayawada?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which is the best fertility hospital in Vijayawada?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which hospital has the best fertility doctors in Vijayawada?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which hospital is best for PCOD/PMOS (PCOS) treatment in Vijayawada?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which is the best hospital for fertility counseling in Vijayawada?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "What is the cost of IUI treatment in Vijayawada?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "Dr. No: 40-16/1-37, 1st Floor, Georgepet, Near D-Address Mall, Labbipet",
            ...
            "url": "https://sudhafertilitycentre.com/fertility-centre-in-vijayawada",
            "sameAs": [
