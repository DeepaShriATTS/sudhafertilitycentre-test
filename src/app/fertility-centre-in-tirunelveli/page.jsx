...
export default function page() {
  ...
  return (
    <div>
      <Script
        id="breadcrumb-schema-tirunelveli"
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "BRANCH",
                "item": "https://sudhafertilitycentre.com/fertility-centre-in-tirunelveli"
              }
            ]
          })
        }}
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "What fertility treatments are available in Tirunelveli?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "What is the cost of IVF in Tirunelveli?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "What is the cost of fertility treatments in Tirunelveli?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "How can I choose the best fertility hospital in Tirunelveli?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which is the best fertility hospital in Tirunelveli?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which hospital has the best fertility doctors in Tirunelveli?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which hospital is best for PCOD/PMOS (PCOS) treatment in Tirunelveli?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "What is the cost of IUI treatment in Tirunelveli?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
      ...
      <Script
        type="application/ld+json"
        id="structured-data-tirunelveli"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "MedicalClinic",
            ...
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "66-J, First Floor, Thiruvananthapuram Road West, New Bus Stand",
            ...
            "url": "https://sudhafertilitycentre.com/fertility-centre-in-tirunelveli",
            "sameAs": [
