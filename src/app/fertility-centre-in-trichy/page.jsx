...
export default function page() {
  ...
  return (
    <div>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "BRANCH",
                "item": "https://sudhafertilitycentre.com/fertility-centre-in-trichy"
              }
            ]
          })
        }}
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "What fertility treatments are available in Trichy?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "What is the cost of IVF in Trichy?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "What is the cost of fertility treatments in Trichy?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "How can I choose the best fertility hospital in Trichy?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which is the best fertility hospital in Trichy?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which hospital has the best fertility doctors in Trichy?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which hospital is best for PCOD/PMOS (PCOS) treatment in Trichy?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which is the best hospital for fertility counseling in Trichy?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "What is the cost of IUI treatment in Trichy?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
      ...
      <Script
        type="application/ld+json"
        id="structured-data-tiruchirappalli"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "MedicalClinic",
            ...
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "C/O, Rangga Hotel, Williams Road, Opposite to Femina Hotel, Cantonment",
            ...
            "url": "https://sudhafertilitycentre.com/fertility-centre-in-trichy",
            "sameAs": [
