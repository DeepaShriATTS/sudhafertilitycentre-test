          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "BRANCH",
                "item": "https://sudhafertilitycentre.com/fertility-centre-in-attapur"
              }
            ]
          })
        }}
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "What fertility treatments are available in Attapur?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "What is the cost of IVF in Attapur?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "What is the cost of fertility treatments in Attapur?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "How can I choose the best fertility hospital in Attapur?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which is the best fertility hospital in Attapur?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which hospital has the best fertility doctors in Attapur?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which hospital is best for PCOD/PMOS (PCOS) treatment in Attapur?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "What is the cost of IUI treatment in Attapur?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "Pillar Number 147, Zoi Hospitals Campus, Rambagh Colony, Attapur",
            ...
            "geo": {
              "@type": "GeoCoordinates",
              "latitude": "17.36299458",
              "longitude": "78.4284336"
            },
            ...
            "url": "https://sudhafertilitycentre.com/fertility-centre-in-attapur",
            "sameAs": [
