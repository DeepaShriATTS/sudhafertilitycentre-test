...
export default function page() {
  ...
  return (
    <div>
      ...
      <Script
        id="breadcrumb-schema-ramanathapuram"
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "BRANCH",
                "item": "https://sudhafertilitycentre.com/fertility-centre-in-ramanathapuram"
              }
            ]
          })
        }}
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "What fertility treatments are available in Ramanathapuram?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "There are many fertility treatments available, Sudha Fertility Centre in Ramanathapuram provides personalised treatments suitable to your needs. We offer various treatments including IVF, ICSI, IUI, and fertility preservation options. As the best fertility centre in Ramanathapuram, we specialise in providing comprehensive care with advanced technologies."
                }
              },
              {
                "@type": "Question",
                "name": "What is the cost of IVF in Ramanathapuram?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "The cost of IVF treatment in Ramanathapuram depends on many factors like your medical history, the number of cycles it takes, hormonal conditions, etc. The average cost of IVF treatment in Ramanathapuram may vary for each individual. At Sudha Fertility Centre, with the best IVF doctors in Ramanathapuram, we provide exceptional IVF treatments tailored to your needs and lifestyle. Our patient-centered approach retains us as the best IVF hospital in Ramanathapuram."
                }
              },
              {
                "@type": "Question",
                "name": "What is the cost of fertility treatments in Ramanathapuram?",
                "acceptedAnswer": {
                  "@type": "Answer",
              ...
              {
                "@type": "Question",
                "name": "How can I choose the best fertility hospital in Ramanathapuram?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "When choosing the best fertility hospital you have to look at these factors, the location of the hospital, the treatments they offer, the facilities, the success rates, and the expertise of the fertility doctors in the hospital. Sudha Fertility Centre, the best fertility hospital in Ramanathapuram is equipped with world-class facilities and the best fertility experts and holds a high success rate."
                }
              },
              {
                "@type": "Question",
                "name": "Which is the best fertility hospital in Ramanathapuram?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Sudha Fertility Centre is the best fertility hospital in Ramanathapuram. We offer world-class fertility treatments with intellectually equipped fertility doctors in Ramanathapuram, with a high success rate."
                }
              },
              {
                "@type": "Question",
                "name": "Which hospital has the best fertility doctors in Ramanathapuram?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Dr. S. Pradeepa the chief consultant of Sudha Fertility Centre in Ramanathapuram is one the best fertility experts in Ramanathapuram. This branch is equipped with the best fertility doctors in Ramanathapuram with a record of thousands of couples delivering healthy babies, and free medical camps conducted every month."
                }
              },
              {
                "@type": "Question",
                "name": "Which hospital is best for PCOD/PMOS (PCOS) treatment in Ramanathapuram?",
                "acceptedAnswer": {
                  "@type": "Answer",
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "With an 85% success rate and equipped with the best fertility experts, world-class facilities, and exceptional fertility treatments, Sudha Fertility Centre in Ramanathapuram is the No. 1 fertility hospital in Tamil Nadu."
                }
              },
              {
                "@type": "Question",
              ...
              {
                "@type": "Question",
                "name": "What is the cost of IUI treatment in Ramanathapuram?",
                "acceptedAnswer": {
                  "@type": "Answer",
      ...
      <Script
        type="application/ld+json"
        id="structured-data-ramanathapuram"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "MedicalClinic",
            ...
            "url": "https://sudhafertilitycentre.com/fertility-centre-in-ramanathapuram",
            "sameAs": [
