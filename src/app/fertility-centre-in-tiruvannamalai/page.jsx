...
export default function page() {
  ...
  return (
    <div>
      <Script
        id="breadcrumb-schema-tiruvannamalai"
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "BRANCH",
                "item": "https://sudhafertilitycentre.com/fertility-centre-in-tiruvannamalai"
              }
            ]
          })
        }}
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "What fertility treatments are available in Tiruvannamalai?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "What is the cost of IVF in Tiruvannamalai?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "What is the cost of fertility treatments in Tiruvannamalai?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "How can I choose the best fertility hospital in Tiruvannamalai?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which is the best fertility hospital in Tiruvannamalai?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which hospital has the best fertility doctors in Tiruvannamalai?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              {
                "@type": "Question",
                "name": "Which hospital is best for PCOD/PMOS (PCOS) treatment in Tiruvannamalai?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
                    "With a high success rate and equipped with the best fertility experts, world-class facilities, and exceptional fertility treatments, Sudha Fertility Centre in Tiruvannamalai is the No. 1 fertility hospital in Tamil Nadu.",
                },
              },
              {
                "@type": "Question",
              ...
              {
                "@type": "Question",
                "name": "What is the cost of IUI treatment in Tiruvannamalai?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text":
      ...
      <Script
        type="application/ld+json"
        id="structured-data-tiruvannamalai"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "MedicalClinic",
            ...
            "url": "https://sudhafertilitycentre.com/fertility-centre-in-tiruvannamalai",
            "sameAs": [
