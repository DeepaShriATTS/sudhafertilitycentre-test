...
import { Outfit, Inter, Noto_Sans_Kannada, Fraunces } from "next/font/google";
...
// Replaces the render-blocking @import in hero-banner-slider.css.
// Fraunces is a variable font — next/font self-hosts the woff2 and injects
// an optimised <link rel="preload">. No weight array for variable fonts;
// all weights (300-900) are available in the single .woff2 file.
const fraunces = Fraunces({
  variable: "--font-fraunces",
  subsets: ["latin"],
  display: "swap",
  preload: true, // Hero heading uses this font — preload for LCP
});
  ...
  return (
    <html lang="en-IN">
      <head>
        ...
        {/* fonts.googleapis.com preconnects removed: next/font self-hosts all fonts. */}
      ...
      <body className={` ${outfit.variable} ${inter.variable} ${notoSansKannada.variable} ${fraunces.variable} antialiased font-outfit`}>
        <SkipToContent />
