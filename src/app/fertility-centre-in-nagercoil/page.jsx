...
export default function page() {
  ...
  return (
    <div>
      ...
      <Script
        id="breadcrumb-schema-nagercoil"
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "BRANCH",
                "item": "https://sudhafertilitycentre.com/fertility-centre-in-nagercoil"
              }
            ]
          })
        }}
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "What fertility treatments are available in Nagercoil?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "There are many fertility treatments available, Sudha Fertility Centre in Nagercoil provides personalised treatments suitable to your needs. We offer various treatments including IVF, ICSI, IUI, and fertility preservation options. As the best fertility centre in Nagercoil, we specialise in providing comprehensive care with advanced technologies."
                }
              },
              {
                "@type": "Question",
                "name": "What is the cost of IVF in Nagercoil?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "The cost of IVF treatment in Nagercoil depends on many factors like your medical history, the number of cycles it takes, hormonal conditions, etc. The average cost of IVF treatment in Nagercoil may vary for each individual. At Sudha Fertility Centre, with the best IVF doctors in Nagercoil, we provide exceptional IVF treatments tailored to your needs and lifestyle. Our patient-centered approach retains us as the best IVF hospital in Nagercoil."
                }
              },
              {
                "@type": "Question",
                "name": "What is the cost of fertility treatments in Nagercoil?",
                "acceptedAnswer": {
                  "@type": "Answer",
              ...
              {
                "@type": "Question",
                "name": "How can I choose the best fertility hospital in Nagercoil?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "When choosing the best fertility hospital you have to look at these factors, the location of the hospital, the treatments they offer, the facilities, the success rates, and the expertise of the fertility doctors in the hospital. Sudha Fertility Centre, the best fertility hospital in Nagercoil is equipped with world-class facilities and the best fertility experts and holds a high success rate."
                }
              },
              {
                "@type": "Question",
                "name": "Which is the best fertility hospital in Nagercoil?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Sudha Fertility Centre is the best fertility hospital in Nagercoil. We offer world-class fertility treatments with intellectually equipped fertility doctors in Nagercoil, with a high success rate."
                }
              },
              {
                "@type": "Question",
                "name": "Which hospital has the best fertility doctors in Nagercoil?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Dr. S. Pradeepa the chief consultant of Sudha Fertility Centre in Nagercoil is one the best fertility experts in Nagercoil. This branch is equipped with the best fertility doctors in Nagercoil with a record of thousands of couples delivering healthy babies, and free medical camps conducted every month."
                }
              },
              {
                "@type": "Question",
                "name": "Which hospital is best for PCOD/PMOS (PCOS) treatment in Nagercoil?",
                "acceptedAnswer": {
                  "@type": "Answer",
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "With a high success rate and equipped with the best fertility experts, world-class facilities, and exceptional fertility treatments, Sudha Fertility Centre in Nagercoil is the No. 1 fertility hospital in Tamil Nadu."
                }
              },
              {
                "@type": "Question",
              ...
              {
                "@type": "Question",
                "name": "What is the cost of IUI treatment in Nagercoil?",
                "acceptedAnswer": {
                  "@type": "Answer",
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "530, MS Road, Vetturnimadam",
            ...
            "geo": {
              "@type": "GeoCoordinates",
              "latitude": "8.189796234",
              "longitude": "77.41476023"
            },
            ...
            "url": "https://sudhafertilitycentre.com/fertility-centre-in-nagercoil",
            "sameAs": [
